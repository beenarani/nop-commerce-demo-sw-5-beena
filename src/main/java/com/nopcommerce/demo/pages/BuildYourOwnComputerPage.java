...
public class BuildYourOwnComputerPage extends Utility {
    ...
    public void clickOnAddToCart() {
        clickOnElement(addToCatButton);        //CLick add to cart
        CustomListeners.test.log(Status.PASS, "Click on " + addToCatButton);
        Reporter.log("Click on " + addToCatButton.toString());
    }
}